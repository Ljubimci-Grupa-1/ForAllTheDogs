...
//    private lateinit var messageRepository: MessageRepository
    ...
    fun addNewAd() {
        ...
        `when`(colorRepository.findByColorName(color1.colorName)).thenReturn(color1)
        `when`(speciesRepository.findBySpeciesName(species1.speciesName)).thenReturn(species1)
